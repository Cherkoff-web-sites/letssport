const ROLES = {
  parent: {
    id: "parent",
    title: "Родитель",
    hint: "Посещение своих детей, сумма к оплате и отметка «оплатил»"
  },
  trainer: {
    id: "trainer",
    title: "Тренер",
    hint: "Посещаемость: +, пусто, 500. Можно дописать пробника"
  },
  admin: {
    id: "admin",
    title: "Координатор",
    hint: "Посещаемость, состав группы и пробники. Расчётом не занимается"
  },
  director: {
    id: "director",
    title: "Руководитель",
    hint: "Посещаемость, расчёт абонемента, тариф и оплаты"
  }
};
...
function can(role, action) {
  ...
  const map = {
    ...
    addTrial: ["trainer", "admin", "director"],
    removeChild: ["admin", "director"],
    removeOwnTrial: ["trainer"],
    viewOwnBilling: ["parent", "director"],
    viewAllBilling: ["director"],
    editDiscount: ["director"],
    editSettings: ["director"],
    markPaid: ["parent", "director"]
  };
...
function filterState(db, role, familyId) {
  ...
  const payload = {
    ...
    permissions: {
      ...
      addTrial: can(r, "addTrial"),
      removeChild: can(r, "removeChild"),
      removeOwnTrial: can(r, "removeOwnTrial"),
      settings: can(r, "editSettings"),
      markPaid: can(r, "markPaid")
    }
  };
